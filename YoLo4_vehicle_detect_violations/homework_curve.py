...
cap = cv2.VideoCapture('19.mp4')
out = cv2.VideoWriter('output.mp4', -1, 20.0, (720, 1280))

count = 0
vcount = 0
area = [(860, 700), (680, 550), (580, 450), (550, 400),(550, 370),(575, 355),(580, 355), (560, 370),(560, 400),(590, 450), (700, 550), (880, 700)]
region_id = set()
center_pre_frame = []
tracking_id = 0
tracking_obj = {}
...
while cap.isOpened():
    ...
    cv2.line(frame1, (860, 700), (680, 550), (0, 255, 0), 2)
    cv2.line(frame1, (680, 550), (580, 450), (0, 255, 0), 2)
    cv2.line(frame1, (580, 450), (550, 400), (0, 255, 0), 2)
    cv2.line(frame1, (550, 400), (550, 370), (0, 255, 0), 2)
    cv2.line(frame1, (550, 370), (575, 355), (0, 255, 0), 2)
    cv2.line(frame1, (580, 355), (560, 370), (0, 255, 0), 2)
    cv2.line(frame1, (560, 400), (560, 370), (0, 255, 0), 2)
    cv2.line(frame1, (590, 450), (560, 400), (0, 255, 0), 2)
    cv2.line(frame1, (700, 550), (590, 450), (0, 255, 0), 2)
    cv2.line(frame1, (880, 700), (700, 550), (0, 255, 0), 2)
    ...
    for object_id, pt in tracking_obj.items():
        ...
        print(cx, " ", cy)
        inside_region = cv2.pointPolygonTest(np.array(area), (int(cx+15), int(cy)), False)
        print(inside_region)
        if inside_region > 0:
